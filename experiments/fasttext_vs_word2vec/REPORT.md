...
Auto-generated by `compare_lib.generate_report()`. Covers 9 language(s): `af`, `eu`, `hi`, `kk`, `ko`, `mk`, `ta`, `th`, `vi`.
...
**Overall mean speedup across all languages run so far: 2.14x**
