...
Output is used by [`04_postprocessing/`](../04_postprocessing/) to prepare data for the Shiny app, and by [`06_manuscript/`](../06_manuscript/) for reported results. See [`word2manylanguages_workflow.ipynb`](../word2manylanguages_workflow.ipynb) for a walk-through that drives this module alongside the other two stages.
